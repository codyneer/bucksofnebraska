...
export function ReviewCard({
  ...
  const content = (
    <div className="min-w-[260px] max-w-[260px] sm:min-w-[300px] sm:max-w-[300px] bg-white border border-border-light p-4 sm:p-5 snap-start cursor-pointer transition-all duration-300 hover:shadow-lg hover:-translate-y-[3px] hover:border-red flex-shrink-0">
