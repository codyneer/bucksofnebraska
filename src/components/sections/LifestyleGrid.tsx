...
export function LifestyleGrid() {
  return (
    <section className="py-12 sm:py-20 px-4 sm:px-10 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-[2fr_1fr_1fr] lg:grid-rows-2 gap-1.5">
        <div className="relative col-span-2 lg:col-span-1 lg:row-span-2 aspect-[3/4] lg:aspect-auto overflow-hidden">
          <Image
