...
const platforms = [
  { name: 'Spotify', url: 'https://open.spotify.com/show/bucksofnebraska', color: 'bg-[#1DB954]' },
  { name: 'Apple Podcasts', url: 'https://podcasts.apple.com/us/podcast/bucks-of-nebraska', color: 'bg-[#9933CC]' },
  { name: 'YouTube', url: 'https://www.youtube.com/@BucksofNebraska', color: 'bg-[#FF0000]' },
  { name: 'Amazon Music', url: 'https://music.amazon.com/podcasts/bucks-of-nebraska', color: 'bg-[#00A8E1]' },
]
  ...
  return (
    <div className="py-12 sm:py-20 px-4 sm:px-10 max-w-[800px] mx-auto">
      ...
      <div className="space-y-4">
        <article className="bg-white border border-border-light p-6 flex gap-5 items-start cursor-pointer transition-all duration-300 hover:shadow-lg hover:border-red group">
